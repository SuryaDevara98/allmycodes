...
<h2>Hello Sir/Madam, Please login to book an Appointmnets</h2>
 <div  style="  margin-left: 5%; margin-right:5%; width: 5%; margin:0px 300px; padding:10px 20px; align:left;">
<a href="./patientregister"><h2>Register</h2></a>
</div>
...
<form action="./patientloginconfirm" method="post">
...
<div class="form-group">4
  ...
  <input  name="appointmentId" placeholder="provide your user Id" type="number">
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <input name="patientPassword" placeholder="provide your password" type="password">
    </div>
  </div>
</div>
